...
options = ['pxe', 'testpxe', 'test_iso', 'bootstrap', 'testbootstrap', 'cli', 'upgrade', 'install_cluster', 'addnode',
           'decommission', 'install', 'setup', 'setup_ipv6', 'replace', 'preserve', 'entitle', 'rotatekeys']
options.sort()
...
def main(option):
    ...
    elif option == 'install_cluster':
        obj.install_multiple()
